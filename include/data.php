  ...
  <?
    for($n=1; $n<=8; $n++){
      ...
      if($data['no']){
        ...
        // 뷰링크
        $data_view_link = './sub.php?olym=30&amp;mode=view&amp;no='.$data['no'];
      }
  ?>
  <li>
    <?if($data['no']){?>
...
<p class="more"><a href="./sub.php?olym=30"><img src="<?echo($projectUrl);?>design/main/icon_more.gif" width="31" height="5" alt="자료실 더보기" /></a></p>